...
const ServicesSection = () => {
  const services = [
    {
      icon: <ChartLine className="h-10 w-10 text-nural-600" />,
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="border border-gray-100 nural-shadow hover:shadow-lg transition-shadow duration-300">
