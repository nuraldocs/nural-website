        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-5 order-2 md:order-1">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold gradient-text">Alex Morgan</h3>
              <p className="text-gray-700 leading-relaxed">
                With over 15 years of experience in financial markets, Alex Morgan founded Neural with a mission to transform how traders approach the markets. After starting his career at a major Wall Street firm, Alex realized that most trading education failed to address the psychological aspects of trading.
              </p>
              <p className="text-gray-700 leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                <div className="flex flex-col items-center p-4 bg-white rounded-lg neural-shadow">
                  ...
                  <h4 className="font-semibold text-center">15+ Years Experience</h4>
                </div>
                <div className="flex flex-col items-center p-4 bg-white rounded-lg neural-shadow">
            ...
            <div className="relative">
              <div className="aspect-[16/9] rounded-xl overflow-hidden neural-shadow">
                <img 
                  ...
                  alt="Alex Morgan, Founder of Neural" 
